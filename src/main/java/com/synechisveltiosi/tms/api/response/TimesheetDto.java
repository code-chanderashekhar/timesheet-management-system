 ...
 */
public record TimesheetDto(UUID id, Collection<TimesheetEntryDto> entries, EmployeeDto employee, Collection<TimesheetApprovalDto> approvals) implements Serializable {
